 ...
 * clears the fixed navbar (h-24 / h-20 once scrolled). Unlike Dining/Meetings,
 * there's no `package` category record for services in the CMS yet, so this
 * reads straight from the static copy in data.ts.
 */
