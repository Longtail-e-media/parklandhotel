  ...
  return (
    ...
    >
      <Swiper
        ...
        navigation={{ prevEl: ".service-gallery-prev", nextEl: ".service-gallery-next" }}
        pagination={{ clickable: true, el: ".service-gallery-pagination" }}
      ...
      >
        ...
        {images.length > 1 && (
          <div slot="container-end" className="flex items-center justify-between gap-4 my-5">
            <div className="service-gallery-pagination flex items-center gap-2 static! w-auto!" />
            <div className="flex items-center gap-3 me-1">
              <button
                type="button"
                aria-label="Previous photo"
                className="testimonial-nav-btn service-gallery-prev w-10! h-10! hover:bg-(--color-primary-green) hover:cursor-pointer"
              >
              ...
              <button
                ...
                className="testimonial-nav-btn service-gallery-next w-10! h-10! hover:bg-(--color-primary-green) hover:cursor-pointer border-0"
              >
