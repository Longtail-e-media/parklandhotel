...
export const hero = {
  ...
  subtitle:
    "Experience refined hospitality surrounded by the untamed beauty of Chitwan— just a minutes from the heart of Sauraha and the gateway to Chitwan National Park.",
  image: "/img/hero.jpg",
